# ⚠️ УСТАРЕЛО — заменено на SPOT_SIGNAL_POLICY_v6.5.md (17.09.2026)

Описанная ниже фазовая логика (`Bottom ≥70% → ПОКУПАТЬ`, правила по фазам
EARLY_BULL/ACCUMULATION) в коде больше НЕ реализована. Сейчас модель считает
целевую долю позиции и выводит ярлык из неё. Оставлено как история решений.
