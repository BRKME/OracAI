...
WALLETS = {
    ...
    # MMA_2 (0x91dad140...) и MMA_5 (0x5a51f62d...) сняты с отслеживания
    # 28.08.2026 — позиций в них не было. MMA_4 (0x4e724095...) снят 30.05.2026.
    # Исторические записи под этими метками в state/*.json не трогаем: это
    # аудит-история, а не конфиг на будущее.
}
